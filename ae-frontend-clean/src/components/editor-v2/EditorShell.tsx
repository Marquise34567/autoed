  ...
  return (
    <main className="fixed inset-0 z-0 bg-[#05060a] text-white overflow-hidden">
      <div className="pointer-events-none absolute inset-0 overflow-hidden -z-10" aria-hidden>
        <div className="absolute left-1/2 -translate-x-1/2 -top-20 w-130 h-130 rounded-full bg-[#7c3aed]/20 blur-[120px]" />
        <div className="absolute -right-24 top-[18%] w-90 h-90 rounded-full bg-[#06b6d4]/18 blur-[120px]" style={{ animationDelay: '1.2s' }} />
